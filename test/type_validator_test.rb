...
class TypeValidatorTest < ActiveSupport::TestCase
  ...
  test "it accepts a single integer for type int" do
    validator = Brita::TypeValidator.new(1, :int)
    expected_validation = { valid_int: true }
